...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // 기본 default 세팅 추가
    StudentInfoDto studentInfoDto = new StudentInfoDto("홍길동", 20, "강남");
    StudentInfoDto studentInfoDto1 = new StudentInfoDto("김철수", 20, "수서");
    ...
    CourseInfoDto courseInfoDto2 = new CourseInfoDto(
            "SPRING",
            2000,
            "MONDAY",
            "김철수",
